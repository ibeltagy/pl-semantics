...
if [[ "$varBind" == "false"* ]]; then
   ...
   rangeVals="-150 151-300 301-450 451-600 601-750 751-900 901-1050 1051-1200 1201-1350 1351-1500"
else
   ...
   do
	...
	do
		...
		do
            ...
            outputFile="$ds-irLvl$irLvl-peInf$peInf-vectorMaker$vectorMaker-noDup$noDup-scaleW$scaleW-maxProb$maxProb-wThr$wThr-range-.$range"
#				echo $outputFile
#   			continue
				...
				for range in $rangeVals
                  ...
                  outputFile="$outputFile-range-.$range"
