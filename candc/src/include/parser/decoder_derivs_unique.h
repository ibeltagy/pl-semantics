...
namespace NLP {
  namespace CCG {
    ...
    class DerivsUniqueDecoder: public DepsRecallDecoder {
    public:
      DerivsUniqueDecoder(const ushort k, const uchar k_alg)
          : DepsRecallDecoder(k, k_alg) {}
      virtual ~DerivsUniqueDecoder(void){ /* do nothing */ }
