...
namespace NLP {
  namespace CCG {
    ...
    public:
      ...
      Rules(Pool *pool, const Markedup &markedup, const bool EXTRA_RULES, const bool NOISY_RULES, const ushort k = 1)
        : EXTRA_RULES(EXTRA_RULES), NOISY_RULES(NOISY_RULES),
          pool(pool), markedup(markedup), k(k),
      ...
      bool right_punct(const SuperCat *sc1, const SuperCat *sc2, bool tb_rules,
        ...
        res.push_back(SuperCat::Punct(pool, sc1->cat, SuperCat::RIGHT_PUNCT | inherited, sc1, sc2, sc1, k));
